...
- You'll see a window with instructions
- The app is now running in the background!

#### Typing in Bangla
1. **Open any application** (Notepad, Word, Browser, etc.)
2. **Type phonetically in English**:
   - Type: `amar` → Press Space → Get: `আমার`
   - Type: `bangla` → Press Space → Get: `বাংলা`
   - Type: `tumi kemon acho` → Press Space after each word
   
3. **Press F9** to switch between Bangla and English typing

#### Examples

| Type This | Press Space | You Get |
|-----------|-------------|---------|
| `ami` | Space | `আমি` |
| `tumi` | Space | `তুমি` |
| `bangla` | Space | `বাংলা` |
...
- This is a false positive - the app only monitors your typing to help you

**Problem**: Not working in some apps
